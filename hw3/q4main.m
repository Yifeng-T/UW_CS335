...
g=inline('x-(x^2-3)*(3^(0.5)/6)');
%the coefficient of (x^2-3) should in interval (0, 3^(0.5)/3);
...
switch method 
  ...
  case 3,
    x = newton(f,fprime,a,tol,maxiter); 
  case 4,
    x = fixedpoint(g,a,tol,maxiter); 
end;
%
